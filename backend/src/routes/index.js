...
const appAlertRoutes = require('./appAlertRoutes');
const appRuntimeConfigRoutes = require('./appRuntimeConfigRoutes');
...
router.use("/app-alert", appAlertRoutes);
router.use('/app-config', appRuntimeConfigRoutes);
